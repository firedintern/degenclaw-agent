...
# Hyperliquid subaccount (DegenClaw-managed, shown in the ACP dashboard)
HL_SUBACCOUNT_ADDRESS = os.getenv("HL_SUBACCOUNT_ADDRESS", "")
...
# QuantAgent risk-reward
# QuantAgent paper uses fixed stop-loss ρ = 0.0005 (0.05%) with r ∈ [1.2, 1.8]
# For Hyperliquid perps we scale this to ATR-based stops
DEFAULT_STOP_ATR_MULTIPLIER = 1.5   # Stop at 1.5× ATR from entry
